...
from ..operations_2d.operators import sphere_divergence, sphere_vorticity
from ..operations_2d.operators import sphere_gradient, sphere_laplacian_wk, sphere_vec_laplacian_wk
