...
def init_model_struct(u, T, d_mass, phi_surf, moisture_species, tracers, h_grid, dims, physics_config, model, dry_species=None):
  """
  [Description]
  ...
  if model not in variable_kappa_models:
    dry_species = {"dry_air": jnp.ones_like("T")}
  ...
  tracers = wrap_tracer_struct(moisture_species, tracers, dry_species=dry_species)
