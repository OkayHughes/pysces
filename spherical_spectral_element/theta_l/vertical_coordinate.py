...
def dmass_from_coordinate(ps, v_grid):
  da = (v_grid["hybrid_a_i"][jnp.newaxis, jnp.newaxis, jnp.newaxis, 1:] - v_grid["hybrid_a_i"][jnp.newaxis, jnp.newaxis, jnp.newaxis, :-1])
  db = (v_grid["hybrid_b_i"][jnp.newaxis, jnp.newaxis, jnp.newaxis, 1:] - v_grid["hybrid_b_i"][jnp.newaxis, jnp.newaxis, jnp.newaxis, :-1])
